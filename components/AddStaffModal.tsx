...
const AddStaffModal: React.FC<AddStaffModalProps> = ({ visible, onClose, onSubmit }) => {
        ...
        <View style={styles.modalContainer}>
          ...
          <View style={styles.modalHeader}>
            <View style={styles.modalHeaderContent}>
              <Text style={styles.modalTitle}>Ajouter un Membre du Personnel</Text>
          ...
          <View style={styles.modalActions}>
            ...
            <TouchableOpacity style={styles.saveButton} onPress={handleSubmit}>
              <Text style={styles.saveText}>Ajouter le Membre</Text>
            </TouchableOpacity>
          </View>
        </View>
      </View>
